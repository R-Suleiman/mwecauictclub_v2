...
Route::get('departments/{deptname}', [App\Http\Controllers\HomeController::class, 'departmentPage'])->name('single-department.page');
...
Route::controller(AdminController::class)->prefix('admin')->middleware('admin')->group(function () {
    ...
    Route::get('departments/{id}', 'showDepartment')->name('admin.departments.show');
    Route::get('departments/{id}/edit', 'editDepartment')->name('admin.departments.edit');
    Route::put('departments/{id}', 'updateDepartment')->name('admin.departments.update');
